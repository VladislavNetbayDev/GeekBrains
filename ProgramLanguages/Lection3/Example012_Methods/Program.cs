...
// {
//     for (int j = 0; j <= 10; j++) // j - второе число 
//     {
...
// Задача: Дан текст, нужно заменить пробелы черточками, маленькие буквы "к" заменить большими "К", а большие "С" заменить маленькими "С" Лекция 3 19:46
